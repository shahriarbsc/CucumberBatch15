...
public class APIWorkflowSteps {
    ...
    // making a request using usual payload
    RequestSpecification request;
    Response response;
    public static String employee_id;


    // here we are working with cucumber framework:
    ...
    @Then("the employee id {string} is stored as a global variable to be stored as a global variable to be used other calls")
    public void the_employee_id_is_stored_as_a_global_variable_to_be_stored_as_a_global_variable_to_be_used_other_calls(String string) {

        // storing the employee id in global variable

        // this path of employee id is coming from feature file
        // you can change the name of parameter as per your choice i wont mind.
    ...
    */
    ...
    public void a_request_is_prepared_to_created_employee() {
    ...
    @Then("the employe data we get having id {string} must match with globally stored employee id")
    public void the_employe_data_we_get_having_id_must_match_with_globally_stored_employee_id(String string) {
    ...
    public void the_retrieved_data_at_object_matches_with_the_data_of_created_employee(String empObject, DataTable dataTable) {
        ...
        for (Map<String, String> map : expectedData) {
            ...
            for (String key : keys) {
                ...
                // it will store the value against the key (Keys variable)
                String expectedValue = map.get(key);         // map.get method return
...
//-----------------------------------------------------------------------------------------
    ...
    public void a_request_is_prepared_to_create_an_employee_with_dynamic_data(String firstName, String
            lastName, String middleName, String gender, String birthDay, String status, String jobTitle) {
        request = given().
